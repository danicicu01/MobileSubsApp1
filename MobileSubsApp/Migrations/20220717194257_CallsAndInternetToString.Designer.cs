...
namespace MobileSubsApp.Migrations
{
    ...
    [Migration("20220717194257_CallsAndInternetToString")]
    partial class CallsAndInternetToString
    {
            ...
            modelBuilder.Entity("MobileSubsApp.Models.Subscription", b =>
                {
                    ...
                    b.Property<string>("InternationalCalls")
                        .IsRequired()
                    ...
                    b.Property<string>("NationalCalls")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
